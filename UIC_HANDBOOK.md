...
- **Response Template:**
  > "Hello [Name], thanks for reaching out! It's great to hear you played at [League Abbreviation]. We'd love to have you back in blue. To get started, please register here: [[League] Registration Link]. Once you've signed up, I'll send you the info for the next training session and how to self-assign games. Welcome back!"
...
- **The Mechanism:** 
  1. Create a Google Form (e.g., "[League] Umpire Feedback").
...
- **The Link:** [[Local Field Status Link]]
- **The Hotline:** If the digital status is down, call the [[Agency Name]] Field Condition Hotline at **[Hotline Number]**.
- **The Update:** Ensure you check for updates by the designated daily deadline (e.g., 3:00 PM). 
...
- **Plate Umpire:** $60.00
- **Base Umpire:** $45.00
- **Solo Game:** If an umpire works a game solo, they work the plate and the rate is **$60.00**.
